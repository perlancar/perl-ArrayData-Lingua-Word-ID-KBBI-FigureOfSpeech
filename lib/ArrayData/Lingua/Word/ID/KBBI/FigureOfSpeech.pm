package ArrayData::Lingua::Word::ID::KBBI::FigureOfSpeech;
...
1;
# ABSTRACT: Indonesian figure of speech (kiasan) entries from KBBI (Kamus Besar Bahasa Indonesia), 3e

=head1 DESCRIPTION

=head1 SEE ALSO

L<WordList::ID::KBBI::FigureOfSpeech> contains the same data.
